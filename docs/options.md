...
| --output_display_aim_port | int | 5380 | aim port of the web display |
...
| --output_display_type | array | ['none'] | output display, either visdom, aim or no output<br/><br/> **Values:** visdom, aim, none |
| --output_display_visdom_autostart | flag |  | whether to start a visdom server automatically |
| --output_display_visdom_port | int | 8825 | visdom port of the web display |
